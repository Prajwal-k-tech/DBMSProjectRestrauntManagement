              ...
              >
                <div className="flex flex-wrap items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {/* Delete Button */}
                    <button
                      onClick={() => handleDeleteOrder(order.order_id, order.customer_name)}
                      className="px-3 py-2 bg-mocha-red/20 text-mocha-red border border-mocha-red/50 rounded-lg text-sm font-medium hover:bg-mocha-red hover:text-mocha-base transition-colors focus:outline-none focus:ring-2 focus:ring-mocha-red"
                      title="Delete Order"
                    >
